...
// C
    ...
    {
		return (ve.net.alge.grpc.core.domains.models.I_AD_AppSupport_Para)MTable.get(getCtx(), ve.net.alge.grpc.core.domains.models.I_AD_AppSupport_Para.Table_Name)
