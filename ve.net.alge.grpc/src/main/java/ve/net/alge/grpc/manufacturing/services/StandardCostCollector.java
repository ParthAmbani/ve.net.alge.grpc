...
package ve.net.alge.grpc.manufacturing.services;
...
import ve.net.alge.grpc.core.domains.models.MPPCostCollector;
import ve.net.alge.grpc.core.domains.models.MPPOrderCost;
import ve.net.alge.grpc.eevolution.model.RoutingService;
import ve.net.alge.grpc.eevolution.model.RoutingServiceFactory;
...
//		costDetailVariance.setM_CostType_ID(costType.getM_CostType_ID());// TODO core
		costDetailVariance.setM_CostElement_ID(costElement.getM_CostElement_ID());
		costDetailVariance.setAmt(amount);
//		costDetailVariance.setCostAmt(amount);// TODO core
//		costDetailVariance.setAmtLL(BigDecimal.ZERO);// TODO core
