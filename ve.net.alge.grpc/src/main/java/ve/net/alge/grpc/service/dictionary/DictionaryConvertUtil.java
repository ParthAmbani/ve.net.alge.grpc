...
//			.setIsRange(column.isRange())// TODO core
	...
	public static Field.Builder convertFieldByElemnt(Properties context, M_Element element) {
		...
		//	Display Type
//		int displayTypeId = element.getAD_Reference_ID();// TODO core
...
//			.setDisplayType(displayTypeId)// TODO core
//			.setFieldLength(element.getFieldLength())
		;
		//	
//		if (ReferenceUtil.validateReference(displayTypeId)) {// TODO core
//			//	Reference Value
