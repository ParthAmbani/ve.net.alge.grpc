 ...
 ************************************************************************************/
package ve.net.alge.grpc.logic;
...
import ve.net.alge.grpc.util.GeneralLedgerConvertUtil;
...
//			.setLimit(limit, offset)
		...
		// 	.<MRefList>list()
		IntStream.of(tableAccountigIds).boxed().collect(Collectors.toList()).forEach(tableId -> {
