...
public class X_AD_AttachmentReference extends PO implements I_AD_AttachmentReference, I_Persistent 
{
	...
	public I_AD_Archive getAD_Archive() throws RuntimeException
    {
		return (I_AD_Archive)MTable.get(getCtx(), I_AD_Archive.Table_Name)
	...
	public ve.net.alge.grpc.core.domains.models.I_AD_AppRegistration getFileHandler() throws RuntimeException
    {
		return (ve.net.alge.grpc.core.domains.models.I_AD_AppRegistration)MTable.get(getCtx(), ve.net.alge.grpc.core.domains.models.I_AD_AppRegistration.Table_Name)
