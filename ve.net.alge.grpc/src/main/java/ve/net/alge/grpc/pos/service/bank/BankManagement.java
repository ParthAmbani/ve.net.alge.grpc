...
package ve.net.alge.grpc.pos.service.bank;
...
public class BankManagement {
	...
	public static ListBanksResponse.Builder listBanks(ListBanksRequest request) {
		...
		//	Get List
		int[] banksIdsList = query
//			.setLimit(limit, offset)
			.getIDs()
		;

		IntStream.of(banksIdsList).boxed().collect(Collectors.toList()).parallelStream().forEach(tableId -> {
	...
	public static ListBankAccountsResponse.Builder listBankAccounts(ListBankAccountsRequest request) {
		...
		//	Get List
		IntStream.of(query.getIDs()).boxed().collect(Collectors.toList()).forEach(bankAccountId -> {
