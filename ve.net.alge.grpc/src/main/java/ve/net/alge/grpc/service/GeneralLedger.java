...
import ve.net.alge.grpc.logic.GeneralLedgerServiceLogic;
...
public class GeneralLedger extends GeneralLedgerImplBase {
	...
	private Entity.Builder getAccountingCombination(GetAccountingCombinationRequest request) {
		...
		if(request.getId() > 0) {
//			accountingCombination = MAccount.getValidCombination(Env.getCtx(), request.getId(), null);// TODO core
...
//		}// TODO core
		int user4Id = 0;
//		if (attributesList.get(MAccount.COLUMNNAME_User4_ID) != null) {// TODO core
...
//			);// TODO core
	...
	private ExistsAccoutingDocumentResponse.Builder existsAccoutingDocument(ExistsAccoutingDocumentRequest request) {
		...
		if (
//				!documentTable.isDocument() || // TODO core
				documentTable.isView()) {
