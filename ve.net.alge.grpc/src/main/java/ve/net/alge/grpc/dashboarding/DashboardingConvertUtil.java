...
package ve.net.alge.grpc.dashboarding;
...
import ve.net.alge.grpc.service.dictionary.DictionaryConvertUtil;
...
public class DashboardingConvertUtil {
	...
	public static Favorite.Builder convertFavorite(X_AD_TreeNodeMM treeNodeMenu) {
		...
		MMenu menu = MMenu.get(context, treeNodeMenu.getNode_ID());
...
//			else if (menu.getAction().equals(MMenu.ACTION_SmartBrowse) && menu.getAD_Browse_ID() > 0) {// TODO core
