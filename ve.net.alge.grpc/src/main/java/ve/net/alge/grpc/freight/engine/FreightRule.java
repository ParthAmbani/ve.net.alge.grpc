...
package ve.net.alge.grpc.freight.engine;
...
import ve.net.alge.grpc.freight.services.FreightService;
import ve.net.alge.grpc.freight.services.FreightServiceInterface;
...
public class FreightRule implements FreightRuleInterface {
	...
	public FreightInfo calculate(Properties ctx, int shipperId, int locationId, int locationToId, int freightCategoryId,
        ...
        if (maybeFreight.isPresent()) {
        	...
        	MFreightCategory freightCategory = new MFreightCategory(ctx, freightCategoryId, trxName);
//        	if(Util.isEmpty(freightCategory.getFreightCalculationType())// TODO core
