...
import org.spin.backend.grpc.enrollment.ActivateUserRequest;
import org.spin.backend.grpc.enrollment.ActivateUserResponse;
...
import org.spin.backend.grpc.enrollment.ResetPasswordTokenRequest;
import org.spin.backend.grpc.enrollment.User;

import io.grpc.Status;
import io.grpc.stub.StreamObserver;
import ve.net.alge.grpc.core.domains.models.I_AD_Token;
 ...
 */
public class Enrollment extends RegisterImplBase {
	/**	Logger			*/
	private CLogger log = CLogger.getCLogger(Enrollment.class);
...
//		newUser.setIsInternalUser(false);// TODO core
	...
	private void sendEMail(MUser user, MADToken token) {
		...
		//	Get
		int mailTextId = 0;// clientInfo.getRestorePassword_MailText_ID();// TODO have to add in the core
		if(mailTextId <= 0) {
