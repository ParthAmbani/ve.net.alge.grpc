 ...
 ************************************************************************************/
package ve.net.alge.grpc.dictionary.util;
...
public class WindowUtil {
	...
	public static Map<String, Integer> getTableColumnsDisplayType(MTable table) {
		MColumn[] tableColumns = table.getColumns(true);
		...
		for (MColumn column : tableColumns) {
			displayTypeColumns.put(column.getColumnName(), column.getAD_Reference_ID());
		}
