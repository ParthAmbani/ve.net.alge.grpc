...
import ve.net.alge.grpc.pipo.exception.BOMExpiredException;
import ve.net.alge.grpc.pipo.exception.RoutingExpiredException;
/**
 *  PP Order Model.
 *
...
//					MOrder.DELIVERYRULE_AfterReceipt.equals(orderLine.getParent().getDeliveryRule()) ||.// TODO core
