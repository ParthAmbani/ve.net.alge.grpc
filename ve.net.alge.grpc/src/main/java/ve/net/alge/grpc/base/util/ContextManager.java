 ...
 *************************************************************************************/
package ve.net.alge.grpc.base.util;
...
////		MCountry country = MCountry.get(Env.getCtx(), language.getCountryCode());// TODO core
//		//	Verify
//		if(country != null) {
//			return country;
//		}
	...
	public static String getDefaultLanguage(String language) {
		...
		if(Util.isEmpty(language)) {
			language = Language.getBaseLanguage().getAD_Language(); // Language.AD_Language_en_US;
		}
		...
		if(Util.isEmpty(defaultLanguage)) {
			defaultLanguage = Language.getBaseLanguage().getAD_Language();// AD_Language_en_US;
		}
		//	Default return
		return defaultLanguage;
	}
