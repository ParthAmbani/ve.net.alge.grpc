...
public class X_C_BankMatcher extends PO implements I_C_BankMatcher, I_Persistent 
{
	...
	public I_C_BankStatementMatcher getC_BankStatementMatcher() throws RuntimeException
    {
		return (I_C_BankStatementMatcher)MTable.get(getCtx(), I_C_BankStatementMatcher.Table_Name)
