...
public class PaymentConvertUtil {
	...
	public static Payment.Builder convertPayment(MPayment payment) {
		...
		//	
		MRefList reference = MRefList.get(Env.getCtx(), SystemIDs.REFERENCE_DOCUMENTSTATUS, payment.getDocStatus(), payment.get_TrxName());
...
//			.setBankId(payment.getC_Bank_ID())// TOOD core
			.setCustomer(
		...
		;
//		if(payment.getCollectingAgent_ID() > 0) {// TODO core
