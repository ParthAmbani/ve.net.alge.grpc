 ...
 *****************************************************************************/
package ve.net.alge.grpc.eca62.support;
...
public class ResourceMetadata {
	...
	public String getResourcePath() {
		...
		String clientUuid = MClient.get(Env.getCtx(), clientId).get_UUID();
		...
		if(userId > 0) {
			String userUuid = MUser.get(Env.getCtx(), userId).get_UUID();
			...
			String roleUuid = MRole.get(Env.getCtx(), roleId).get_UUID();
